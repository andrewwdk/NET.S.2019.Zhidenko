...
namespace UnitTests
{
    ...
    public class BooksTests
    {
        ...
        public void FormattedBookByName_ReturnsCorrectResult()
        {
            ...
            Assert.AreEqual("Book: Name - name1", b.ToString());
        }
        ...
        public void FormattedBookByAllFields_ReturnsCorrectResult()
        {
            ...
            Assert.AreEqual("Book: Isbn - 1 Name - name1 Author - author1 Publisher - publisher1 " +
                "Year of publication - 2019 Count of page - 100 Price - 10", b.ToString());
        }
    }
}
